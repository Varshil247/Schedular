...
class Page(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.logo = tk.Label(self.topFrame, text = 'Schedular > Student Dashboard', font=LargeFont)
        ...
        self.titleLbl = tk.Label(self.mainFrame, text = f'WELCOME TO THE STUDENT DASHBOARD', bg = '#2c2f33')
        ...
        command = lambda: self.controller.show_frame(STimetable.Page))
